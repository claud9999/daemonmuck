...
unsigned hash(register char *s, unsigned hash_size) {
	unsigned hashval;
 ...
 */
hash_entry *
add_hash(register char *name, hash_data data, hash_tab * table, unsigned size) {
	register hash_entry *hp = NULL;
	unsigned hashval;
 ...
 */
int free_hash(register char *name, hash_tab * table, unsigned size) {
	register hash_entry **lp = NULL, *hp = NULL;
...
void kill_hash(hash_tab * table, unsigned size, int freeptrs) {
	register hash_entry *hp = NULL, *np = NULL;
	int i = 0;
